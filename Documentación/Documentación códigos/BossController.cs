...
public class BossController : MonoBehaviour
{
	...
	private void BulletHell()
	{
		...
		bulletHellSpawnerScript.StopEmit(); // Detener la emisión de partículas antes de activar el objeto hijo

		bulletHellSpawnerScript.ClearParticles(); // Eliminar todas las partículas existentes en el objeto hijo

		bulletHellSpawner.SetActive(true); // Activar el objeto hijo (lluvia de balas)

		bulletHellSpawnerScript.enabled = true; // Activar la lluvia de balas
	...
	// Método para disminuír la barra de vida del jefe
